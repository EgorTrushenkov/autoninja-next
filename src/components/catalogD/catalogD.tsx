...
async function getData() {
    const res = await fetch('https://script.google.com/macros/s/AKfycbxGF8-ZeQSS1OKKE8jQJiy5a_CofxJOX9cDgsoMLUH64P49WGnrfgDoHI6cH7_g2kNV/exec')
        ...
        <>
            ...
            <div className="catalog">
                <div className="container">
                    ...
                    <button onClick={getData()}>Console</button>
                    {/* <div className="tabs">
