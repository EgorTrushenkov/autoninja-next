                    ...
                    <div className="body-advantages">
                        <div className="block-adv">
                            <div className="img-text">
                                <img src="/_src/icon-adv/icon-1.webp" alt=""/>
                        ...
                        <div className="block-adv">
                            <div className="img-text">
                                <img src="/_src/icon-adv/icon-2.webp" alt=""/>
                        ...
                        <div className="block-adv">
                            <div className="img-text">
                                <img src="/_src/icon-adv/icon-3.webp" alt=""/>
                        ...
                        <div className="block-adv">
                            <div className="img-text">
                                <img src="/_src/icon-adv/icon-4.webp" alt=""/>
                        ...
                        <div className="block-adv block-adv-full">
                            <div className="img-text">
                                <img src="/_src/icon-adv/more.png" alt=""/>
                                <h1>большой выбор</h1>
                            </div>
